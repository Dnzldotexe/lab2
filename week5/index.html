...
<body>
    ...
    <nav>
        <!-- Home  -->
        <a id="home" href="https://socitcloud.apc.edu.ph/~dtcempron/lab2/week5/">dtcempron</a>
        <!-- Socials  -->
        <a href="https://www.linkedin.com/in/danzielc/" target="_blank"><img id="linkedin" src="IMAGES/linkedin-box-fill.png" alt="LinkedIn Icon"></a>
        <a href="https://github.com/Dnzldotexe/lab2" target="_blank"><img id="github" src="IMAGES/github-fill.png" alt="GitHub Icon"></a>
    </nav>
    <!-- Profile  -->
    <div id="profile">
        <!-- Profile Picture  -->
        <img style="width: 300px; height: 300px; object-fit: none; object-position: top;border-radius: 50%;" src="IMAGES/profile-image.jpg" alt="Photo of Me">
        <!-- My Name  -->
        <p>Danziel Cempron</p>
    </div>
    <!-- About Me  -->
    ...
    <div class="container-1">
        ...
        <div id="films-container">
            <div class="films">
                ...
                <p>Breaking Bad</p><p class="rating"><img id="star" src="IMAGES/star-fill.png" alt="My Rating">5</p>
            </div>
            <div class="films">
                ...
                <p>Game of Thrones</p><p class="rating"><img id="star" src="IMAGES/star-fill.png" alt="My Rating">4</p>
            </div>
            <div class="films">
                ...
                <p>Loki</p><p class="rating"><img id="star" src="IMAGES/star-fill.png" alt="My Rating">5</p>
            </div>
            <div class="films">
                ...
                <p>The Last of Us</p><p class="rating"><img id="star" src="IMAGES/star-fill.png" alt="My Rating">5</p>
            </div>
            <div class="films">
                ...
                <p>Gravity Falls</p><p class="rating"><img id="star" src="IMAGES/star-fill.png" alt="My Rating">5</p>
            </div>
            <div class="films">
                ...
                <p>Regular Show</p><p class="rating"><img id="star" src="IMAGES/star-fill.png" alt="My Rating">5</p>
            </div>
            <div class="films">
                ...
                <p>Adventure Time</p><p class="rating"><img id="star" src="IMAGES/star-fill.png" alt="My Rating">5</p>
            </div>
            <div class="films">
                ...
                <p>Avatar: The Last Airbender</p><p class="rating"><img id="star" src="IMAGES/star-fill.png" alt="My Rating">5</p>
            </div>
            <div class="films">
                ...
                <p>The Legend of Korra</p><p class="rating"><img id="star" src="IMAGES/star-fill.png" alt="My Rating">4</p>
            </div>
            <div class="films">
                ...
                <p>Memento</p><p class="rating"><img id="star" src="IMAGES/star-fill.png" alt="My Rating">5</p>
            </div>
            <div class="films">
                ...
                <p>The Prestige</p><p class="rating"><img id="star" src="IMAGES/star-fill.png" alt="My Rating">5</p>
            </div>
            <div class="films">
                ...
                <p>The Dark Knight</p><p class="rating"><img id="star" src="IMAGES/star-fill.png" alt="My Rating">5</p>
            </div>
            <div class="films">
                ...
                <p>Inception</p><p class="rating"><img id="star" src="IMAGES/star-fill.png" alt="My Rating">5</p>
            </div>
            <div class="films">
                ...
                <p>The Wolf of Wall Street</p><p class="rating"><img id="star" src="IMAGES/star-fill.png" alt="My Rating">4.5</p>
            </div>
            <div class="films">
                ...
                <p>Parasite</p><p class="rating"><img id="star" src="IMAGES/star-fill.png" alt="My Rating">5</p>
            </div>
            <div class="films">
                ...
                <p>Ghost in the Shell</p><p class="rating"><img id="star" src="IMAGES/star-fill.png" alt="My Rating">5</p>
            </div>
            <div class="films">
                ...
                <p>Invincible</p><p class="rating"><img id="star" src="IMAGES/star-fill.png" alt="My Rating">5</p>
            </div>
            <div class="films">
                ...
                <p>Jujutsu Kaisen</p><p class="rating"><img id="star" src="IMAGES/star-fill.png" alt="My Rating">5</p>
            </div>
            <div class="films">
                ...
                <p>Arcane</p><p class="rating"><img id="star" src="IMAGES/star-fill.png" alt="My Rating"><img id="star" src="IMAGES/star-fill.png" alt="My Rating">5</p>
            </div>
            <div class="films">
                ...
                <p>Attack on Titan</p><p class="rating"><img id="star" src="IMAGES/star-fill.png" alt="My Rating">4.5</p>
            </div>
            <div class="films">
                ...
                <p>Cowboy Bebop</p><p class="rating"><img id="star" src="IMAGES/star-fill.png" alt="My Rating">5</p>
            </div>
            <div class="films">
                ...
                <p>Steins;Gate</p><p class="rating"><img id="star" src="IMAGES/star-fill.png" alt="My Rating">4</p>
            </div>
            <div class="films">
                ...
                <p>Spider-Man: Into the Spider-Verse</p><p class="rating"><img id="star" src="IMAGES/star-fill.png" alt="My Rating">4.5</p>
            </div>
            <div class="films">
                ...
                <p>Spider-Man: Across the Spider-Verse</p><p class="rating"><img id="star" src="IMAGES/star-fill.png" alt="My Rating">5</p>
            </div>
        </div>
    </div>
    <div class="container-1">
    ...
    <div class="container-1">
        ...
        <p>GCash - <span id="gcash">09568952244</span>
            <img style="width: 18px; margin-left: 0.3rem;" id="copy-clipboard" src="IMAGES/file-copy-line.png" alt="Copy Icon" onclick="copyText('gcash')">
        </p>
        <p>Maya - <span id="maya">639765044618</span>
            <img style="width: 18px; margin-left: 0.3rem;" id="copy-clipboard" src="IMAGES/file-copy-line.png" alt="Copy Icon" onclick="copyText('maya')">
        </p>
    ...
    <div style="margin: 2rem 0;">
       <a id="link-hover" href="https://socitcloud.apc.edu.ph/~dtcempron/lab2/week5/resources.html" target="_blank">Resources</a>
    </div>
